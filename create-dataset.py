...
def main(args):
    ...
    for i in range(int(args.iterations)):
        ...
        os.system(args.rostPath + "/bin/words.mix --timestep=1250 -o " + basePath + "-all-words.csv -i 436 " + basePath + "-color.csv 1000 " + basePath + "-texton.csv 5000 " + basePath + "-orb.csv")
